...
myscratch="/home/wwu227/thesis/mediation2_mini/scratch"  # location of your persistent scratch dir
resultdir="/home/wwu227/thesis/mediation2_mini/scratch/out"  # This is a folder in permanent storage
script=$1      # your code as (R or Python) script (1st arg)
max_jobs=20  # max number of jobs 10
loops=1   # total number of jobs 4
...
for i in $(seq 1 ${loops}); do
	...
	echo "#SBATCH --partition=benkeser" >> script$i.sh
